Pod::Spec.new do |goSellSDK|
    ...
    goSellSDK.homepage              = 'https://github.com/AlexDBaraka/goSellSDK-iOS'
    goSellSDK.source                = { :git => 'https://github.com/AlexDBaraka/goSellSDK-iOS.git', :tag => goSellSDK.version.to_s }
